    ...
    <body oncontextmenu="return false">
        ...
        <div class="page-container">
            ...
            <form action="sign" method="post">
				<div>
					<input type="text" name="sno" class="username" placeholder="学号 " autocomplete="off"  pattern="20[0-9a-zA-Z]+"/>
				</div>
				<div>
					<input type="text" name="name" class="username" placeholder="姓名" autocomplete="off" required pattern=".+"/>
				</div>
				<div style="float: left;">
					<input type="radio" name="sex" class="sex" value="1" />男 <input type="radio" name="sex" class="sex" value="0">女
				</div>
				<div>
					<input type="text" name="academy" class="username" placeholder="院系" autocomplete="off" required/>
				</div>
				<div>
					<input type="text" name="major" class="username" placeholder="专业" autocomplete="off" required/>
				</div>
				<div>
					<input type="text" name="phone" class="username" placeholder="手机" autocomplete="off" required pattern="1\d{10}"/>
				</div>
                
                <input  style="background-color: orangered" type="submit" value="我要打乒乓！！"></input>
            </form>
            <div class="connect">
