...
<div class="content" id="content" >
    ...
    <ul>
        <c:forEach var="news" items="${news}">
            ...
            <li>
                <div style="float: left"><input type="checkbox" name="ids" form="newsCheckbox" value="<c:out value="${news.id}"/>"></div>
    ...
    <button formaction="deleteNews" form="newsCheckbox">删除</button>
    <button onclick="window.location.href='intoAddNews'">添加</button>
...
<script>
    ...
    function upPage() {
        ...
        window.location.href='newsManager?currentPage='+currentPage;
    }
